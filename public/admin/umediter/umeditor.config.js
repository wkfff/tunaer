...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/admin/umediter/php/imageUp.php"             //图片上传提交地址
        ...
        ,toolbar:[
            'source emotion | undo redo | bold italic underline strikethrough | superscript subscript | forecolor backcolor | removeformat |',
