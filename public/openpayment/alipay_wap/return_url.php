...
// require_once "./../../openapi/i_Memcached.php" ;
...
if($result) {//验证成功
	...
	if( $check->num_rows ) {
		...
		echo "<br>";
		echo "<h1><a href='/wap' style='color:#ff536a;'>返回情缘首页</a></h1>";
		return ;
	}
	// die;
	//插入充值记录
	$sql = " insert into mobile_charge (uid,money,chargefrom,orderid) values (".$uid.",'".$money."','alipay_wap','".$out_trade_no."') ";
...
<h1><a href="/wap" style="color:#ff536a;">返回情缘首页</a></h1>
</body>
</html>
