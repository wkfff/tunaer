...
//    设置徒步分类
    ...
    Route::get("/payorder","IndexController@payorder");
//    Route::get("/exportfenche","IndexController@exportfenche");
    ...
    Route::get("/zuopins/{did}","IndexController@zuopins");
...
Route::group(['namespace'=>'Web',"middleware"=>'logined'],function(){
    ...
    Route::post('/deldata', 'PostController@deldata');
