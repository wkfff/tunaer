...
@section("content")
    ...
    <input type="text" name="title" placeholder="游记标题" style="width:900px;margin-bottom:10px;height:35px;" >
...
@section("htmlend")
    ...
    <script>
        ...
        function fabu() {
            ...
            $.post("/admin/dofabuyouji",{"title":title,"tuwen":tuwen,"pic":pic},function(d){
                if( ajaxdata(d) ) {
                    toast("发布成功");
