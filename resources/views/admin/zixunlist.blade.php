...
@section("content")
    ...
    <table class="table">
        ...
        @for ($i = 0; $i < count($list); $i++)
            <tr>
                <td>{{$list[$i]->id}}</td>
                <td class="center"><a style="width:300px;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;display: inline-block;" href="/zixun/detail/{{$list[$i]->id}}">{{$list[$i]->title}}</a></td>
