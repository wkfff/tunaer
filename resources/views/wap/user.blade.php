            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" style="padding:40px;">
                    ...
                    <div class="payimg" style="width:100%;overflow-y: auto;" >
                        ...
                        <a id="wechatlink" href="#" target="_blank" onclick="$('#payfooter').css('display','block');$('#paybox').modal('show');"><p >微信支付<img style="cursor:pointer;vertical-align: middle;margin-left:15px;height:50px;" src="/web/images/wxpay.png" ></p></a>
                        <br>
                        <div id="qrcode"></div>
                    </div>
                </div>
