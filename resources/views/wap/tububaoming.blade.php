...
@section("body")
    ...
    <div class="content" style="margin-top:50px;background-color:#F2F8FC;" >
        ...
        <div onclick="$('#myModal2').modal('show')" style="padding:5px 10px;border-bottom:1px solid #ddd;position: relative;color:#FF9531;font-size:16px;background: #fff" ><span style="margin:10px;" class="glyphicon glyphicon-plus-sign" ></span>添加游客</div>
        <div style="height:40px;line-height:40px;background: #f5f5f5;padding:0 10px;margin-top:10px;" >
